module.exports = {
  ...
  PJ_QOS_TYPE_BEST_EFFORT: 0,
  PJ_QOS_TYPE_BACKGROUND: 1,
  PJ_QOS_TYPE_VIDEO: 2,
  PJ_QOS_TYPE_VOICE: 3,
  PJ_QOS_TYPE_CONTROL: 4,

  PJ_QOS_PARAM_HAS_DSCP: 1,
  PJ_QOS_PARAM_HAS_SO_PRIO: 2,
  PJ_QOS_PARAM_HAS_WMM: 4,

  PJ_QOS_WMM_PRIO_BULK_EFFORT: 0,
  PJ_QOS_WMM_PRIO_BULK: 1,
  PJ_QOS_WMM_PRIO_VIDEO: 2,
  PJ_QOS_WMM_PRIO_VOICE: 3,
